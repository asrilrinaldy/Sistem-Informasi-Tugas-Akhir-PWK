                ...
                <center>
                    <div class="circular--portrait">
											<?php if($this->session->userdata('ses_foto')!= null){?>
												<img class="img-responsive" src="<?php echo base_url()?>assets/upload/foto/mahasiswa/<?php echo $this->session->userdata('ses_foto')  ?>" alt="User profile picture">
											<?php }else{?>
    ...
    <div class="main-panel">
      <nav class="navbar navbar-default">
		...
		<div class="content">
          ...
          <?php }; ?>
					<div class="content">
						<?php echo form_open_multipart('profile/update_mahasiswa');?>
									...
									<div id="home" class="tab-pane fade in active">
										<table class="table table-striped">
											<tr>
												...
												<td>:</td>
												<td colspan="2"><input type="text" name="nim" id="nim" placeholder="Username" class="form-control" value="<?php echo $this->session->userdata('ses_id')?>" readonly></td>
											</tr>
											<tr>
												<td>E-mail</td>
												<td>:</td>
                      ...
                      <tr>
                        ...
                        <td>:</td>
                        <td colspan="2">
                          <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control" value="<?php echo $this->session->userdata('ses_tempatlahir')?>" />
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>:</td>
                        <td colspan="2">
                          <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control" value="<?php echo $this->session->userdata('ses_tanggallahir')?>" />
                        </td>
                      </tr>
											<tr>
												<td>Foto</td>
